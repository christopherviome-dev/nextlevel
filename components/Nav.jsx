...
function tabsFor(isAdmin) {
  const tabs = [
    ...
    { href: "/requests", label: "My Requests", short: "Requests", icon: Icon.requests },
    { href: "/dashboard", label: "My Shop", icon: Icon.shop },
  ];
...
export default function Nav() {
  ...
  const { authToken, myAccount, isAdmin, logout } = useAuth();
